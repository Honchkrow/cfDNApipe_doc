...
.. note::
   This function is calling gatk GetPileupSummaries, please install GATK before using.
...
.. code:: python
    ...
    getPileup(bamInput=None, biallelicvcfInput=None, 
              outputdir=None, stepNum=None, 
              upstream=None, threads=1,
              verbose=False, other_params=None)
